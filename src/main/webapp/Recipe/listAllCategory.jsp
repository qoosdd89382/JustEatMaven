...
<%
	List<CuisineCategoryVO> list = categorySvc.getAll();
	...
	<div class="searchbar col-12">
		...
		<div class="table-responsive">
				...
				<c:forEach var="categoryVO" items="${list}" varStatus="status">
						<tr data-id="${categoryVO.cuisineCategoryID}">
						<td><a class="btn btn-primary m-1" href="<%= request.getContextPath() %>/Recipe/recipe.do?action=listAllByCategory&id=${categoryVO.cuisineCategoryID}" role="button">${categoryVO.cuisineCategoryName}</a></td>
						</tr>
				</c:forEach>
						</tbody>
					</table>
