...
<%  
	...
	if (!authCode.equals(adminVO.getAdminPassword())) {
		RequestDispatcher successView = 
				request.getRequestDispatcher("/Dashboard/adminRegisterAuth.jsp?adminID=" + adminVO.getAdminID());
		return;
	}
			...
			<div class="login-inner col-12 form-group">
				<form method="post" action="<%= request.getContextPath() %>/Dashboard/admin.do" enctype="multipart/form-data">
					...
					<div class="input-element col-12 input-group mb-3 border-bottom upload-block">
						...
						<button id="upload-btn" class="btn btn-secondary btn-lg form-control form-control-lg rounded-pill btn-block" type="button" id="button-addon2">上傳檔案</button>
						<div class="col-12 preview rounded-pill text-center"><span class="text rounded-circle">預覽圖</span></div>
					</div>
