...
<title>活動列表</title>
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/Event/css/style.css">
<link rel="stylesheet"
...
<body>
	...
	<div class="event_list_content row">
		<div class="center_content col-10">
			...
			<table class="filter">
				<tr class="row">
					<td class="col-12 col-sm-3">類型: <br> <input
						type="checkbox" name="style_filter" id="" value="中式" class="col-1">中式
						<input type="checkbox" name="style_filter" id="" value="日式"
						class="col-1">日式 <input type="checkbox"
						name="style_filter" id="" value="越式" class="col-1">越式 <input
						type="checkbox" name="style_filter" id="" value="西式" class="col-1">西式
						<input type="checkbox" name="style_filter" id="" value="泰式"
						class="col-1">泰式 <input type="checkbox"
						name="style_filter" id="" value="不拘" class="col-1">不拘
					</td>
					<td class="col-12 col-sm-3">地區: <br>
						<form method="post"
							action="<%=request.getContextPath()%>/Event/EventInfo.do"
							class="positionSubmit">
					...
					<td class="col-12 col-sm-3">
						<form method="post"
							action="<%=request.getContextPath()%>/Event/EventInfo.do">
							<input type="text" name="search" placeholder="搜尋活動名稱"
								class="col-12"> <input type="hidden" name="action"
				...
				<c:choose>
					<c:when test="${not empty listfind}">
						<c:forEach var="eventInfoVO" items="${listfind}" varStatus="i">
							<tr class="row">
								<td class="col-sm-2 col-2"><img
									src="<%=request.getContextPath() %>/Event/EventInfoPicServlet?image=${i.index}"
									class="img"></td>
								...
								<td class="col-sm-2 col-2"><fmt:formatDate type="date"
										value="${eventInfoVO.eventStartTime}"
