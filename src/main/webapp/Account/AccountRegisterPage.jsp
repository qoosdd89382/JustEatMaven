...
<!-- 			</div> -->
			...
			<div id="register" class="col-6">
				...
				<form id="register" method="post" action="accountInfo.do">
					...
					<b>請輸入會員姓名 (如王曉明):</b> <input type="text" name="accountName"><br>
					<b>請輸入會員性別 :</b> <input type="radio" name="accountGender" value="1">男
					<input type="radio" name="accountGender" value="2">女 <br>
					<b>請輸入會員生日</b> <input type="date" name="accountBirth"> <br>
					<b>請輸入會員電話 (如0912345678):</b> 
					<input type="text" name="accountPhone"><br> 
					<b>請輸入會員照片 :</b> <input type="file" name="accountPic"><br> 
					<b>請輸入會員身分證正面:</b>
