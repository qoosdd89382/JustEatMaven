...
@WebServlet("/ProductPicShower/Pic/*")
public class ProductPicShower extends HttpServlet {
	private static final long serialVersionUID = 1L;
	Connection con;

	private String product_pic = "SELECT product_pic FROM JustEat.ProductPic where product_id = 400001 limit 1";

	public ProductPicShower() {
		super();
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if(pathInfo.startsWith("Pic/")) {
				pstmt = con.prepareStatement(product_pic);
