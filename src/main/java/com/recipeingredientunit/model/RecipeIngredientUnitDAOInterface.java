...
public interface RecipeIngredientUnitDAOInterface {
	...
	public int delete(RecipeIngredientUnitVO recipeIngredientUnit);	// 回傳筆數確認刪除成功
	public int deleteByRecipe(RecipeIngredientUnitVO recipeIngredientUnit, Connection con);	// 回傳筆數確認刪除成功
